...
import el1 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc1/GP-sc1v1.webp";
import el2 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc1/GP-sc1v2.webp";
import el3 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc1/GP-sc1v3.webp";
import el4 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc1/GP-sc1v4.webp";
import hdtt from "@/assets/Contents/Titlecontents/GrecoPersian.png";
import content1 from "@/assets/Contents/wars/GrecoPersianWar/Gp-sc-ct1.webp";
import hdtt2 from "@/assets/Contents/wars/GrecoPersianWar/Gp-sc-tt2.webp";
import trans1 from "@/assets/Contents/trans1.webp";
import trans2 from "@/assets/Contents/wars/GrecoPersianWar/trans2GP.webp";
import trans2v2 from "@/assets/Contents/wars/GrecoPersianWar/trans2v2GP.webp";
import trans2v3 from "@/assets/Contents/wars/GrecoPersianWar/trans2v3GP.webp";
import el5 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc2/GP-sc2v1.webp";
import el6 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc2/GP-sc2v2.webp";
import el7 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc2/GP-sc2v3.webp";
import el8 from "@/assets/Contents/wars/GrecoPersianWar/GP-sc2/GP-sc2v4.webp";
import content3 from "@/assets/Contents/wars/GrecoPersianWar/Gp-sc-ct2.webp";
...
import el11door from "@/assets/Contents/Doors/GPdoor.webp";
...
import gallery1 from "@/assets/Contents/wars/GrecoPersianWar/Gp-gar-1.webp";
import gallery2 from "@/assets/Contents/wars/GrecoPersianWar/Gp-gar-2.webp";
import gallery3 from "@/assets/Contents/wars/GrecoPersianWar/Gp-gar-3.webp";
...
import trans3v2 from "@/assets/Contents/wars/GrecoPersianWar/trans3GP/trans3GPv3.webp";
import trans3v3 from "@/assets/Contents/wars/GrecoPersianWar/trans3GP/trans3GPv2.webp";
import trans3v4 from "@/assets/Contents/wars/GrecoPersianWar/trans3GP/trans3GPv1.webp";
...
export default {
  ...
  mounted() {
    ...
    const texture1 = new THREE.TextureLoader().load(this.el1);
    const annie1 = new TextureAnimator(texture1, 10, 6, 60, this.AniSpd);
    ...
    image1.position.z = 1 + 0.9;
    image2.position.z = 1 + 0.7;
    image3.position.z = 1 + 0.5;
    image4.position.z = 1 + 0.3;
    ...
    const texturetrans1v2 = new THREE.TextureLoader().load(this.trans1);
    ...
    // create the el8 image
    const textureimage8 = new THREE.TextureLoader().load(this.el8);
    const image8 = new THREE.Mesh(
      new THREE.PlaneGeometry(
        this.sizeimgContent2 + 4,
        this.sizeimgContent2 + 1
      ),
      new THREE.MeshBasicMaterial({
        map: textureimage8,
        side: THREE.DoubleSide,
    ...
    scene.add(image8);
    image8.position.z = -1.3;

    // create the el7 image
    const clock7 = new THREE.Clock();
    const textureimage7 = new THREE.TextureLoader().load(this.el7);
    const annie7 = new TextureAnimator(textureimage7, 10, 6, 60, this.AniSpd);
    ...
    scene.add(image7);
    image7.position.z = -1.2;

    // create the el6 image
    const clock6 = new THREE.Clock();
    const textureimage6 = new THREE.TextureLoader().load(this.el6);
    const annie6 = new TextureAnimator(textureimage6, 10, 6, 60, this.AniSpd);
    ...
    // create the el5 image
    const clock5 = new THREE.Clock();
    const textureimage5 = new THREE.TextureLoader().load(this.el5);
    const annie5 = new TextureAnimator(textureimage5, 10, 6, 60, this.AniSpd);
    ...
    const render = () => {
      ...
      image1.position.x = mouse.x * -0.01;
      image1.position.y = this.img1y - 0.3 + mouse.y * 0.01;
      image2.position.x = mouse.x * -0.02;
      image2.position.y = this.img1y + mouse.y * 0.02;
      image3.position.x = mouse.x * -0.03;
      image3.position.y = this.img1y + mouse.y * 0.03;
      image4.position.x = mouse.x * -0.04;
      image4.position.y = this.img1y + mouse.y * 0.04;
      ...
      imagetrans3v2.position.y = -3.5 + mouse.y * 0.01;
      imagetrans3v3.position.y = -3 + mouse.y * 0.01;
      imagetrans3v4.position.y = -3 + mouse.y * 0.01;
      ...
      image8.position.x = this.img2x + mouse.x * -0.03;
      image8.position.y = this.img2y + mouse.y * 0.03;
      image7.position.x = this.img2x + 0.5 + mouse.x * -0.05;
      image7.position.y = this.img2y - 0.2 + mouse.y * 0.05;
      image6.position.x = this.img2x + mouse.x * -0.03;
      image6.position.y = this.img2y + mouse.y * 0.03;
      image5.position.x = this.img2x + 1 + mouse.x * -0.03;
      image5.position.y = this.img2y + mouse.y * 0.03;
      ...
      // this.content3Opty;
      const content3 = [image8, image7, image6, image5];
