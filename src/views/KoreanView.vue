...
import ct1el1 from "@/assets/Contents/wars/KoreanWar/KW-sc1/KW-sc1v1.webp";
import ct1el2 from "@/assets/Contents/wars/KoreanWar/KW-sc1/KW-sc1v2.webp";
import ct1el3 from "@/assets/Contents/wars/KoreanWar/KW-sc1/KW-sc1v3.webp";
import hdtt from "@/assets/Contents/Titlecontents/Korean.png";
import content1 from "@/assets/Contents/wars/KoreanWar/kw-sc-ct1.webp";
import hdtt2 from "@/assets/Contents/wars/KoreanWar/kw-sc-tt2.webp";
import trans1 from "@/assets/Contents/wars/KoreanWar/trans1K.webp";
import trans1v2 from "@/assets/Contents/wars/KoreanWar/trans1Kv2.webp";
import trans2 from "@/assets/Contents/wars/KoreanWar/trans2K.webp";
import trans2v2 from "@/assets/Contents/wars/KoreanWar/trans2v2K.webp";
import trans2v3 from "@/assets/Contents/wars/KoreanWar/trans2v3K.webp";
import ct2el1 from "@/assets/Contents/wars/KoreanWar/KW-sc2/KW-sc2v1.webp";
import ct2el2 from "@/assets/Contents/wars/KoreanWar/KW-sc2/KW-sc2v2.webp";
import ct2el3 from "@/assets/Contents/wars/KoreanWar/KW-sc2/KW-sc2v3.webp";

import content3 from "@/assets/Contents/wars/KoreanWar/kw-sc-ct2.webp";
...
import el11door from "@/assets/Contents/Doors/Krdoor.webp";
...
import gallery1 from "@/assets/Contents/wars/KoreanWar/kr-gar-1.webp";
import gallery2 from "@/assets/Contents/wars/KoreanWar/kr-gar-2.webp";
import gallery3 from "@/assets/Contents/wars/KoreanWar/kr-gar-3.webp";
...
import trans3v2 from "@/assets/Contents/wars/KoreanWar/trans3Kr/trans3Krv3.webp";
import trans3v3 from "@/assets/Contents/wars/KoreanWar/trans3Kr/trans3Krv2.webp";
import trans3v4 from "@/assets/Contents/wars/KoreanWar/trans3Kr/trans3Krv1.webp";
...
export default {
  ...
  mounted() {
    ...
    // create the ct1el3 image
    const clockct1el3 = new THREE.Clock();
    const texturect1el3 = new THREE.TextureLoader().load(this.ct1el3);
    const anniect1el3 = new TextureAnimator(
      texturect1el3,
      10,
      6,
      60,
    ...
    const imagect1el3 = new THREE.Mesh(
    ...
    const render = () => {
      ...
      const deltact1el3 = clockct1el3.getDelta();
      anniect1el3.update(deltact1el3 * 1000);
      ...
      imagect1el3.position.x = mouse.x * -0.01;
      imagect1el3.position.y = this.img1y + mouse.y * 0.01;
      ...
      imagetrans1.position.y = 0.1 + mouse.y * 0.01;
      imagetrans1v2.position.x = 4.3 + mouse.x * 0.005;
      ...
      imagetrans3v2.position.y = -2.5 + mouse.y * 0.01;
      imagetrans3v3.position.x = this.trans3x + mouse.x * 0.03;
      imagetrans3v3.position.y = -2.8 + mouse.y * 0.01;
      imagetrans3v4.position.x = this.trans3x + mouse.x * 0.03;
      imagetrans3v4.position.y = -2.6 + mouse.y * 0.01;
      ...
      // this.elOpty;
      const images = [imagect1el1, imagect1el2, imagect1el3];
      ...
      // this.content3Opty;
      const content3 = [imagect2el2, imagect2el1, imagect2el3];
