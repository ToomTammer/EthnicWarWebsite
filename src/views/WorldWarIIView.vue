...
import ct1el1 from "@/assets/Contents/wars/WorldWarII/WW2-sc1/WW2-sc1v1.webp";
import ct1el2 from "@/assets/Contents/wars/WorldWarII/WW2-sc1/WW2-sc1v2.webp";
import hdtt from "@/assets/Contents/Titlecontents/wwII.png";
import content1 from "@/assets/Contents/wars/WorldWarII/ww2-sc-ct1.webp";
import hdtt2 from "@/assets/Contents/wars/WorldWarII/ww2-sc-tt2.webp";
import trans1 from "@/assets/Contents/wars/WorldWarI/trans1v1ww.webp";
import trans1v2 from "@/assets/Contents/wars/WorldWarI/trans1v2ww.webp";
import trans2 from "@/assets/Contents/wars/WorldWarI/trans2ww.webp";
import trans2v2 from "@/assets/Contents/wars/WorldWarI/trans2v2ww.webp";
import trans2v3 from "@/assets/Contents/wars/WorldWarI/trans2v3ww.webp";
import ct2el1 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v1.webp";
import ct2el1v2 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v1v2.webp";
import ct2el2 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v2.webp";
import ct2el2v2 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v2v2.webp";
import ct2el3 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v3.webp";
import ct2el4 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v4.webp";
import ct2el4v2 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v4v2.webp";
import ct2el5 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v5.webp";
import ct2el6 from "@/assets/Contents/wars/WorldWarII/WW2-sc2/WW2-sc2v6.webp";

import content3 from "@/assets/Contents/wars/WorldWarII/ww2-sc-ct2.webp";
...
import el11door from "@/assets/Contents/Doors/WWdoor.webp";
...
import gallery1 from "@/assets/Contents/wars/WorldWarII/ww2-gar-1.webp";
import gallery2 from "@/assets/Contents/wars/WorldWarII/ww2-gar-2.webp";
import gallery3 from "@/assets/Contents/wars/WorldWarII/ww2-gar-3.webp";
...
import trans3v2 from "@/assets/Contents/wars/WorldWarII/trans3WWII/trans3WWIIv3.webp";
import trans3v3 from "@/assets/Contents/wars/WorldWarII/trans3WWII/trans3WWIIv2.webp";
import trans3v4 from "@/assets/Contents/wars/WorldWarII/trans3WWII/trans3WWIIv1.webp";
...
export default {
  ...
  mounted() {
    ...
    const content1 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeContent1, this.sizeContent1),
      new THREE.MeshBasicMaterial({
        map: texturecontent1,
        side: THREE.DoubleSide,
        transparent: true,
    ...
    // create the ct2el6 image
    const clockct2el6 = new THREE.Clock();
    const textureimagect2el6 = new THREE.TextureLoader().load(this.ct2el6);
    const anniect2el6 = new TextureAnimator(
      textureimagect2el6,
      10,
      6,
      60,
    ...
    const imagect2el6 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el6,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    scene.add(imagect2el6);
    imagect2el6.position.z = -2;

    // create the ct2el5 image
    const clockct2el5 = new THREE.Clock();
    const textureimagect2el5 = new THREE.TextureLoader().load(this.ct2el5);
    const anniect2el5 = new TextureAnimator(
      textureimagect2el5,
      10,
      6,
      60,
    ...
    const imagect2el5 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el5,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    scene.add(imagect2el5);
    imagect2el5.position.z = -1.8;

    // create the ct2el4 image
    const clockct2el4 = new THREE.Clock();
    const textureimagect2el4 = new THREE.TextureLoader().load(this.ct2el4);
    const anniect2el4 = new TextureAnimator(
      textureimagect2el4,
      10,
      6,
      60,
    ...
    const imagect2el4 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el4,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    // scene.add(imagect2el4);
    imagect2el4.position.z = -1.6;

        // create the ct2el4v2 image
    const textureimagect2el4v2 = new THREE.TextureLoader().load(this.ct2el4v2);
    const imagect2el4v2 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el4v2,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    // scene.add(imagect2el4v2);
    imagect2el4v2.position.z = -1.6;

    // create the ct2el3 image
    const clockct2el3 = new THREE.Clock();
    const textureimagect2el3 = new THREE.TextureLoader().load(this.ct2el3);
    const anniect2el3 = new TextureAnimator(
      textureimagect2el3,
      10,
      6,
      60,
    ...
    const imagect2el3 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el3,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    scene.add(imagect2el3);
    imagect2el3.position.z = -1.4;
    ...
    imagect2el2.position.z = -1.2;
        ...
        // create the ct2el2v2 image
    const textureimagect2el2v2 = new THREE.TextureLoader().load(this.ct2el2v2);
    const imagect2el2v2 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el2v2,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    // scene.add(imagect2el2v2);
    imagect2el2v2.position.z = -1.2;
    ...
    // create the ct2el1v2 image
    const textureimagect2el1v2 = new THREE.TextureLoader().load(this.ct2el1v2);
    const imagect2el1v2 = new THREE.Mesh(
      new THREE.PlaneGeometry(this.sizeimgContent2 + 2, this.sizeimgContent2),
      new THREE.MeshBasicMaterial({
        map: textureimagect2el1v2,
        side: THREE.DoubleSide,
        transparent: true,
        opacity: this.content3Opty,
      })
    );
    // scene.add(imagect2el1v2);

    imagect2el1v2.position.z = -1;
    ...
    imageexit1.position.x = 40;
    imageexit1.position.y = -2.8;
    ...
    const render = () => {
      ...
      const deltact2el3 = clockct2el3.getDelta();
      anniect2el3.update(deltact2el3 * 1000);
      const deltact2el4 = clockct2el4.getDelta();
      anniect2el4.update(deltact2el4 * 1000);
      const deltact2el5 = clockct2el5.getDelta();
      anniect2el5.update(deltact2el5 * 1000);
      const deltact2el6 = clockct2el6.getDelta();
      anniect2el6.update(deltact2el6 * 1000);
      ...
      imagect1el2.position.x = mouse.x * -0.01;
      imagect1el2.position.y = this.img1y + mouse.y * 0.01;
      ...
      imagetrans3v2.position.y = -2.8 + mouse.y * 0.01;
      imagetrans3v3.position.x = this.trans3x + mouse.x * 0.03;
      imagetrans3v3.position.y = -2.6 + mouse.y * 0.01;
      imagetrans3v4.position.x = this.trans3x + mouse.x * 0.03;
      imagetrans3v4.position.y = -2.7 + mouse.y * 0.01;
      ...
      imagect2el1v2.position.x = this.img2x + mouse.x * -0.05;
      imagect2el1v2.position.y = this.img2y + mouse.y * 0.05;

      imagect2el2.position.x = this.img2x + mouse.x * -0.03;
      imagect2el2.position.y = this.img2y + mouse.y * 0.03;
      imagect2el2v2.position.x = this.img2x + mouse.x * -0.03;
      imagect2el2v2.position.y = this.img2y + mouse.y * 0.03;

      imagect2el3.position.x = this.img2x + mouse.x * -0.02;
      imagect2el3.position.y = this.img2y + mouse.y * 0.02;

      imagect2el4.position.x = this.img2x + mouse.x * -0.04;
      imagect2el4.position.y = this.img2y + mouse.y * 0.04;
      imagect2el4v2.position.x = this.img2x + mouse.x * -0.04;
      imagect2el4v2.position.y = this.img2y + mouse.y * 0.04;

      imagect2el5.position.x = this.img2x + mouse.x * -0.05;
      imagect2el5.position.y = this.img2y + mouse.y * 0.05;
      imagect2el6.position.x = this.img2x + mouse.x * -0.05;
      imagect2el6.position.y = this.img2y + mouse.y * 0.05;
